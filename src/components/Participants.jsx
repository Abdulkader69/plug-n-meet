...
const Participants = () => {
    return (
        <div className='participants-wrapper scrollBar absolute z-10 left-0 top-0 h-full w-[270px] pr-10 pl-4 pt-5 overflow-auto multi-gradient'>
            <div className="inner-wrapper relative z-20">
                <div className="close-btn fixed top-[50%] left-[240px] -translate-y-1/2 cursor-pointer">
                ...
                <div className="top flex items-center justify-between font-medium mb-5">
                    <p className='text-sm text-black'>Participants (50)</p>
                    <p className='text-sm text-[#003767]'><span className='opacity-[.52]'>Show:</span> All</p>
                </div>
                    ...
                    {dummyData.map((data) => 
                        <li key={data} className='flex items-center justify-between mb-3'>
                            <div className="left flex items-center">
                                ...
                                <p className='text-[13px] text-[#003767]'>Kasey Jones</p>
                            </div>
                            <div className="right flex items-center">
                                <div className="hand mr-2 cursor-pointer">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="12" height="16" viewBox="0 0 19.683 21.323">
                                ...
                                <div className="mic mr-2 cursor-pointer">
                                    <svg className='opacity-[.52]' xmlns="http://www.w3.org/2000/svg" width="6" height="10" viewBox="0 0 8.722 12.686">
                                ...
                                <div className="option cursor-pointer">
                                    <svg className='opacity-[.52]' xmlns="http://www.w3.org/2000/svg" width="15" height="5" viewBox="0 0 19 5">
