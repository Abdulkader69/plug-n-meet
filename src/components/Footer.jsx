...
const Footer = ({handleJoinAudioPopUp}) => {
    return (
        <footer id='main-footer' className='h-[70px] px-10 shadow-footer flex items-center justify-between'>
            <div className="footer-inner flex items-center justify-between w-full">

                <div className='footer-left flex items-center'>
                    <div className="camera h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 31.772 25.416">
                    ...
                    <div 
                        className="microphone h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer"
                        onClick={handleJoinAudioPopUp}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 32.675 26.141">
                ...
                <div className='footer-middle flex items-center'>
                    <div className="message h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 25.339 25.339">
                    ...
                    <div 
                        className={`participants h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer`}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 26.063 23.167">
                    ...
                    <div className="hands h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="16" viewBox="0 0 24.559 26.606">
                    ...
                    <div className="share-screen h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 30.407 20.271">
                    ...
                    <div className="record h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="28" height="14" viewBox="0 0 41 17">
                    ...
                    <div className="menu h-[40px] w-[40px] overflow-hidden rounded-full bg-[#F2F2F2] hover:bg-[#ECF4FF] mr-6 flex items-center justify-center cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="7" viewBox="0 0 29 7">
                ...
                <div className='footer-right flex items-center'>
                    <div className="close-meeting h-[40px] w-[40px] overflow-hidden rounded-full bg-[#ED2139] flex items-center justify-center cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 27.01 27.008">
